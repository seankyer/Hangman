class GameInstance:
    ...
    def print_letters_shown(self):
        count = 0
        max_count = self.hangman_word.get_word_length
        for count in range(0, max_count):
            print(self.letters_shown[count]),
